...
var stockRoutes = [
  {
    ...
    children: [
      ...
      { path: "dashboard", loadComponent: () => import("./chunk-LBZG5NRF.js").then((m) => m.StockDashboardComponent) },
      { path: "receptions", loadComponent: () => import("./chunk-EOL7WBCZ.js").then((m) => m.ReceptionListComponent) },
      ...
      { path: "expeditions", loadComponent: () => import("./chunk-BMR6TOIQ.js").then((m) => m.LivraisonListComponent) },
      { path: "expeditions/new", loadComponent: () => import("./chunk-IOKN742S.js").then((m) => m.LivraisonDetailComponent) },
      { path: "expeditions/:id", loadComponent: () => import("./chunk-IOKN742S.js").then((m) => m.LivraisonDetailComponent) },
      { path: "transferts", loadComponent: () => import("./chunk-BRNWNWON.js").then((m) => m.TransfertListComponent) },
      { path: "transferts/new", loadComponent: () => import("./chunk-EVPOHOML.js").then((m) => m.TransfertDetailComponent) },
      { path: "transferts/:id", loadComponent: () => import("./chunk-EVPOHOML.js").then((m) => m.TransfertDetailComponent) },
      { path: "categories", loadComponent: () => import("./chunk-DN4MKWKT.js").then((m) => m.CategoryListComponent) },
      { path: "units-of-measure", loadComponent: () => import("./chunk-7F6PCRHA.js").then((m) => m.UnitOfMeasureListComponent) },
      { path: "locations", loadComponent: () => import("./chunk-K43UJWMG.js").then((m) => m.LocationListComponent) },
      { path: "picking-types", loadComponent: () => import("./chunk-R7G6AXH3.js").then((m) => m.PickingTypeListComponent) },
      { path: "analyse/rapport", loadComponent: () => import("./chunk-SVFZT6ST.js").then((m) => m.StockReportComponent) },
      { path: "analyse/rapport-stock", loadComponent: () => import("./chunk-KM47BSZ2.js").then((m) => m.StockAnalysisReportComponent) },
      { path: "analyse/mouvements-analyse", loadComponent: () => import("./chunk-MCVLV5A5.js").then((m) => m.MovementAnalysisComponent) },
      { path: "analyse/mouvements", loadComponent: () => import("./chunk-JOEUGD7O.js").then((m) => m.StockMovementsComponent) },
      { path: "analyse/valorisation", loadComponent: () => import("./chunk-CYDBKFOB.js").then((m) => m.StockValuationComponent) }
    ]
  }
];
export {
