...
var salesRoutes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-RWFVOZKY.js").then((m) => m.SalesDashboardComponent)
      },
      {
        path: "orders",
        loadComponent: () => import("./chunk-P53L3QY2.js").then((m) => m.OrderListComponent)
      },
      {
        path: "orders/new",
        loadComponent: () => import("./chunk-KRGG6MUJ.js").then((m) => m.OrderFormComponent)
      },
      {
        path: "orders/:id",
        loadComponent: () => import("./chunk-KRGG6MUJ.js").then((m) => m.OrderFormComponent)
      ...
      {
        path: "invoices/:id",
        loadComponent: () => import("./chunk-A55YSU4M.js").then((m) => m.InvoiceDetailComponent)
      },
      {
        path: "avoirs",
        loadComponent: () => import("./chunk-GFXJ7J4F.js").then((m) => m.AvoirListComponent)
      },
      {
        path: "payments",
        loadComponent: () => import("./chunk-AJ6YBM36.js").then((m) => m.SalesPaymentListComponent)
      },
      {
        path: "clients",
        loadComponent: () => import("./chunk-VGGDKRJZ.js").then((m) => m.ClientListComponent)
      },
      {
        path: "clients/prix",
        loadComponent: () => import("./chunk-DYMBMEH2.js").then((m) => m.ClientPriceComponent)
      },
      {
        path: "vendeurs",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-QT5UEN3U.js").then((m) => m.StatsVentesComponent)
      },
      {
        path: "reports/rapport-ristournes",
        loadComponent: () => import("./chunk-KNRZA4WN.js").then((m) => m.RapportRistourneComponent)
      },
      {
        path: "ristournes",
        loadComponent: () => import("./chunk-DLCWENRH.js").then((m) => m.RistourneListComponent)
      },
      {
        path: "precomptes",
        loadComponent: () => import("./chunk-CQ3IFOTL.js").then((m) => m.PrecompteConfigComponent)
      },
      {
        path: "eleader/import",
...
//# sourceMappingURL=chunk-RUBXNHQK.js.map
