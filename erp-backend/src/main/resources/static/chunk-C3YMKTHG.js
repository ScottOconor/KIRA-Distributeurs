...
var salesRoutes = [
  {
    ...
    children: [
      ...
      {
        path: "avoirs",
        loadComponent: () => import("./chunk-R2YDFIC7.js").then((m) => m.AvoirListComponent)
      },
      {
        path: "payments",
      ...
      {
        path: "clients",
        loadComponent: () => import("./chunk-WAXZVS7C.js").then((m) => m.ClientListComponent)
      },
      {
        path: "clients/prix",
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-WSNMQ6L2.js").then((m) => m.StatsVentesComponent)
      },
      {
      ...
      {
        path: "ristournes",
        loadComponent: () => import("./chunk-3GAOKMMP.js").then((m) => m.RistourneListComponent)
      },
      {
        path: "precomptes",
        loadComponent: () => import("./chunk-GQSYTEDJ.js").then((m) => m.PrecompteConfigComponent)
      },
      {
        path: "eleader/import",
