...
var purchasesRoutes = [
  {
    ...
    children: [
      ...
      { path: "avoirs", loadComponent: () => import("./chunk-HSTA2YP2.js").then((m) => m.PurchaseAvoirListComponent) },
      ...
      { path: "enlevements", loadComponent: () => import("./chunk-GZ4UGOXJ.js").then((m) => m.EnlevementListComponent) },
      ...
      { path: "rapports/stats-achats", loadComponent: () => import("./chunk-CFF5UG4L.js").then((m) => m.StatsAchatsComponent) }
    ]
  }
];
export {
