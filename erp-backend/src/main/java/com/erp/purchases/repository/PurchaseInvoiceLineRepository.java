...
public interface PurchaseInvoiceLineRepository extends JpaRepository<PurchaseInvoiceLine, Long> {
    ...
    @Query("""
        ...
        """)
    List<PurchaseInvoiceLine> findStatsLines(
    ...
    @Query("""
        ...
        ORDER BY p.name, l.description
        """)
    List<PurchaseInvoiceLine> findStatsLinesFiltered(
        @Param("companyId") Long companyId,
        @Param("dateFrom") LocalDate dateFrom,
        @Param("dateTo") LocalDate dateTo,
    ...
    @Query("""
        ...
        ORDER BY p.name, l.description
        """)
    List<PurchaseInvoiceLine> findAllAvoirLines(
        @Param("companyId") Long companyId,
        @Param("dateFrom") LocalDate dateFrom,
        @Param("dateTo") LocalDate dateTo
    );
    ...
    @Query("""
        ...
        ORDER BY p.name, l.description
        """)
    List<PurchaseInvoiceLine> findAllAvoirLinesFiltered(
        @Param("companyId") Long companyId,
        @Param("dateFrom") LocalDate dateFrom,
        @Param("dateTo") LocalDate dateTo,
        @Param("partnerId") Long partnerId,
